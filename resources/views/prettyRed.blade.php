...
<head>
  ...
  <title>Portfolio - Burung Pretty Red</title>
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-4 col-md-6 portfolio-item">
        <!-- Gambar -->
        <img src="assets/img/masonry-portfolio/pretty red.jpg" alt="pretty Red" class="img-fluid">
        
        <!-- Informasi -->
        <div class="portfolio-info">
          <p>Nama Hewan: Burung Pretty Red</p>
          <p>Umur: 1 tahun</p>
